...
;!(function(window, undefined) {
	...
	function initSeajsConfig()
	{
		...
		seajs.config({
		    ...
		    alias: (function() {
		    	var alias = { "jquery": "/1.2.2/base/jquery/jquery_fda6b489", "jquery_scrollto": "/1.2.2/base/jquery/jquery_scrollto_1bb69295", "ajax": "/1.2.2/base/lang/ajax_194df9ce", "appUtils": "/1.2.2/base/lang/appUtils_f8b8d996", "extnative": "/1.2.2/base/lang/extnative_a1b4d9ee", "gconfig": "/1.2.2/base/lang/gconfig_37984852", "map": "/1.2.2/base/lang/map_5c060a79", "main": "/1.2.2/base/main_560cc688", "sea": "/1.2.2/base/seajs/sea_cea777a2", "startup": "/1.2.2/base/startup_5a131923", "chartsUtils": "{pluginBaseUrl}1.2.2/plugins/charts/scripts/chartsUtils_96d7369c", "highcharts": "{pluginBaseUrl}1.2.2/plugins/charts/scripts/highcharts_145c04a4", "icharts": "{pluginBaseUrl}1.2.2/plugins/charts/scripts/icharts_75d020c4", "ichartsUtils": "{pluginBaseUrl}1.2.2/plugins/charts/scripts/ichartsUtils_0bdb763a", "aes": "{pluginBaseUrl}1.2.2/plugins/endecrypt/scripts/aes_c0df41f4", "des": "{pluginBaseUrl}1.2.2/plugins/endecrypt/scripts/des_cf444a2a", "endecryptUtils": "{pluginBaseUrl}1.2.2/plugins/endecrypt/scripts/endecryptUtils_14cda0f8", "rsa": "{pluginBaseUrl}1.2.2/plugins/endecrypt/scripts/rsa_0e10c50c", "fIscroll": "{pluginBaseUrl}1.2.2/plugins/iscroll/scripts/fIscroll_e37cea46", "hIscroll": "{pluginBaseUrl}1.2.2/plugins/iscroll/scripts/hIscroll_3bb0e4a7", "iscroll": "{pluginBaseUrl}1.2.2/plugins/iscroll/scripts/iscroll_c9b0353b", "shIscroll": "{pluginBaseUrl}1.2.2/plugins/iscroll/scripts/shIscroll_c18d2aee", "svIscroll": "{pluginBaseUrl}1.2.2/plugins/iscroll/scripts/svIscroll_16c92dd9", "vIscroll": "{pluginBaseUrl}1.2.2/plugins/iscroll/scripts/vIscroll_c7db0b19", "keyPanel": "{pluginBaseUrl}1.2.2/plugins/keypanel/scripts/keyPanel_141ed75a", "keyType1": "{pluginBaseUrl}1.2.2/plugins/keypanel/scripts/keyType1_cf181f7d", "keyType2": "{pluginBaseUrl}1.2.2/plugins/keypanel/scripts/keyType2_14b816b1", "keyType3": "{pluginBaseUrl}1.2.2/plugins/keypanel/scripts/keyType3_1f456338", "keyType4": "{pluginBaseUrl}1.2.2/plugins/keypanel/scripts/keyType4_d73a0d70", "keyType5": "{pluginBaseUrl}1.2.2/plugins/keypanel/scripts/keyType5_379e2259", "layer": "{pluginBaseUrl}1.2.2/plugins/layer/scripts/layer_3679a168", "layerUtils": "{pluginBaseUrl}1.2.2/plugins/layer/scripts/layerUtils_51307981", "dateUtils": "{pluginBaseUrl}1.2.2/plugins/mobiscroll/scripts/dateUtils_f5c94113", "mobiscroll": "{pluginBaseUrl}1.2.2/plugins/mobiscroll/scripts/mobiscroll_c6a7d2d1", "external": "{pluginBaseUrl}1.2.2/plugins/nativeintf/scripts/external_33d44919", "msgFunction": "{pluginBaseUrl}1.2.2/plugins/nativeintf/scripts/msgFunction_04a557b4", "nativePluginService": "{pluginBaseUrl}1.2.2/plugins/nativeintf/scripts/nativePluginService_208c0428", "pagingUtils": "{pluginBaseUrl}1.2.2/plugins/page/scripts/pagingUtils_ccee5a01", "service": "{pluginBaseUrl}1.2.2/plugins/service/scripts/base/service_f6180aa1", "validatorUtil": "{pluginBaseUrl}1.2.2/plugins/validator/scripts/validatorUtil_6f874fc6" };
...
define("/1.2.2/base/jquery/jquery_fda6b489", [], function(require, exports, module) {
    (function(a, b) {
        function G(a) {
            var b = F[a] = {};
 ...
 * 扩展jquery，无需export
 */
define("/1.2.2/base/jquery/jquery_scrollto_1bb69295", [ "/1.2.2/base/jquery/jquery_fda6b489" ], function(require, exports, module) {
    var $ = jQuery = require("/1.2.2/base/jquery/jquery_fda6b489");
 ...
 * ajax异步请求数据入口
 */
define("/1.2.2/base/lang/ajax_194df9ce", [ "layerUtils", "/1.2.2/base/lang/gconfig_37984852" ], function(require, exports, module) {
    // 加载依赖模块  
    var layerUtils = require("{pluginBaseUrl}1.2.2/plugins/layer/scripts/layerUtils_51307981");
    var gconfig = require("/1.2.2/base/lang/gconfig_37984852");
    var aes = require("{pluginBaseUrl}1.2.2/plugins/endecrypt/scripts/aes_c0df41f4");
    var external = null;
    /**
 ...
 * 项目相关工具方法
 */
define("/1.2.2/base/lang/appUtils_f8b8d996", [ "/1.2.2/base/lang/gconfig_37984852", "/1.2.2/base/lang/ajax_194df9ce", "layerUtils" ], function(require, exports, module) {
    var gconfig = require("/1.2.2/base/lang/gconfig_37984852");
    var ajax = require("/1.2.2/base/lang/ajax_194df9ce");
    var layerUtils = require("{pluginBaseUrl}1.2.2/plugins/layer/scripts/layerUtils_51307981");
 ...
 * 原生js方法扩展，无需export
 */
define("/1.2.2/base/lang/extnative_a1b4d9ee", [], function(require, exports, module) {
    /** 
 ...
 * 项目自定义配置 || 框架默认值
 */
define("/1.2.2/base/lang/gconfig_37984852", [], function(require, exports, module) {
 ...
 */
define("/1.2.2/base/lang/map_5c060a79", [], function(require, exports, module) {
    function Map() {
 ...
 * 总应用程序入口
 */
define("/1.2.2/base/main_560cc688", [ "/1.2.2/base/lang/extnative_a1b4d9ee", "/1.2.2/base/jquery/jquery_scrollto_1bb69295", "/1.2.2/base/jquery/jquery_fda6b489", "external", "/1.2.2/base/lang/appUtils_f8b8d996", "/1.2.2/base/lang/gconfig_37984852", "/1.2.2/base/lang/ajax_194df9ce" ], function(require, exports, module) {
    function init() {
        /**
	 * 加载所有全局js模块，因为暴露给了window，所以这种只需要加载一次
	 * 扩展原生js方法、jQuery.fn.extend或者jQuery.extend等
	 */
        require("/1.2.2/base/lang/extnative_a1b4d9ee");
        require("/1.2.2/base/jquery/jquery_scrollto_1bb69295");
        require("{pluginBaseUrl}1.2.2/plugins/nativeintf/scripts/external_33d44919");
        // 将 callMessage 方法暴露给原生，供原生回调H5使用
        /************************************初始化*******************************************/
        var appUtils = require("/1.2.2/base/lang/appUtils_f8b8d996"), gconfig = require("/1.2.2/base/lang/gconfig_37984852");
        var layerUtils = require("{pluginBaseUrl}1.2.2/plugins/layer/scripts/layerUtils_51307981");
