 ...
 * 最新发布的组合
 */
define("ytg/scripts/portfolio/newFabu", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        portfolioService=require("portfolioService"),
		pageCode = "portfolio/newFabu", 
		_pageId = "#portfolio_newFabu ";
	...
	function queryNewFaBulist()
	{
		...
		portfolioService.newShow(param,function callBack(resultVo){
			if(0==Number(resultVo.error_no)){
				var result = resultVo.results;
				fillPortfolioData(result[0].data);
			}else{
	...
	var portfolio_newFabu = {
		"init" : init,
		"bindPageEvent" : bindPageEvent,
		"destroy" : destroy
	};

	module.exports = portfolio_newFabu;
});