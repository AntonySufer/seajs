 ...
 * 人气最高组合(粉丝数最多)
 */
define("ytg/scripts/portfolio/renqiTop", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        portfolioService=require("portfolioService"),
		pageCode = "portfolio/renqiTop", 
		_pageId = "#portfolio_renqiTop ";
	...
	var portfolio_renqiTop = {
		"init" : init,
		"bindPageEvent" : bindPageEvent,
		"destroy" : destroy
	};

	module.exports = portfolio_renqiTop;
});