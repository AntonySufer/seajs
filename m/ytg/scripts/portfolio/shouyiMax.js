 ...
 * 收益最高组合
 */
define("ytg/scripts/portfolio/shouyiMax", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        portfolioService=require("portfolioService"),
		pageCode = "portfolio/shouyiMax", 
		_pageId = "#portfolio_shouyiMax ";
	...
	var portfolio_shouyiMax = {
		"init" : init,
		"bindPageEvent" : bindPageEvent,
		"destroy" : destroy
	};

	module.exports = portfolio_shouyiMax;
});