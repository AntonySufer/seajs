 ...
 * 今日黑马组合(日收益最高)
 */
define("ytg/scripts/portfolio/todayHot", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        portfolioService=require("portfolioService"),
		pageCode = "portfolio/todayHot", 
		_pageId = "#portfolio_todayHot ";
	...
	var portfolio_todayHot = {
		"init" : init,
		"bindPageEvent" : bindPageEvent,
		"destroy" : destroy
	};

	module.exports = portfolio_todayHot;
});