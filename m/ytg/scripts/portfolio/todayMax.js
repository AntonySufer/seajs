 ...
 * 今日黑马组合(日收益最高)
 */
define("ytg/scripts/portfolio/todayMax", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        portfolioService=require("portfolioService"),
		pageCode = "portfolio/todayMax", 
		_pageId = "#portfolio_todayMax ";
	...
	var portfolio_todayMax = {
		"init" : init,
		"bindPageEvent" : bindPageEvent,
		"destroy" : destroy
	};

	module.exports = portfolio_todayMax;
});