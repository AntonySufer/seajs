 ...
 * 往期回顾（近30日收益）
 */
define("ytg/scripts/portfolio/wangqiShow", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        portfolioService=require("portfolioService"),
		pageCode = "portfolio/wangqiShow", 
		_pageId = "#portfolio_wangqiShow ";
	...
	var portfolio_wangqiShow = {
		"init" : init,
		"bindPageEvent" : bindPageEvent,
		"destroy" : destroy
	};

	module.exports = portfolio_wangqiShow;
});