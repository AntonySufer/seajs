 ...
 * 历史成交
 */
define("ytg/scripts/userSpace/myPortfolio/queryEntrust/hisDeal", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        portfolioService = require("portfolioService"),
		
		pageCode = "userSpace/myPortfolio/queryEntrust/hisDeal", 
		_pageId = "#userSpace_myPortfolio_queryEntrust_hisDeal ";
	...
	function init() {
		...
		dateUtils.initDateUI("userSpace_myPortfolio_queryEntrust_hisDeal",{"dateFormat":"yyyymmdd"});
	}
	...
	function bindPageEvent() {
		...
		appUtils.bindEvent($(_pageId + ".icon_back"), function(e) {
			...
			if(!isFirstShow){
				isFirstShow = true;
				//同步点击最新问答的返回
				$(" #userSpace_myPortfolio_queryEntrust_hisEntrust " +".icon_back").trigger("mousedown");
			}
		});
	...
	function getHisDeal(insertType){
		...
		portfolioService.queryHisDeal(param,function callBack(resultVo){
