 ...
 * 历史委托
 */
define("ytg/scripts/userSpace/myPortfolio/queryEntrust/hisEntrust",function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        portfolioService = require("portfolioService"),
		
		pageCode = "userSpace/myPortfolio/queryEntrust/hisEntrust", 
		_pageId = "#userSpace_myPortfolio_queryEntrust_hisEntrust ";
	...
	function init() {
		...
		dateUtils.initDateUI("userSpace_myPortfolio_queryEntrust_hisEntrust",{"dateFormat":"yyyymmdd"});
	}
	...
	function bindPageEvent() {
		...
		appUtils.bindEvent($(_pageId + ".icon_back"), function(e) {
			...
			if(!isFirstShow){
				isFirstShow = true;
				//同步点击最新问答的返回
				$(" #userSpace_myPortfolio_queryEntrust_hisDeal" +".icon_back").trigger("mousedown");
			}
		});
	...
	function getHisEntrust(insertType){
		...
		portfolioService.queryHisEntrust(param,function callBack(resultVo){
