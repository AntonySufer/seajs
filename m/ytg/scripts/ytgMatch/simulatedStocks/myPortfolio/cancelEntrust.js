 ...
 * @date 2016-03-16 （改）
 */
define("ytg/scripts/ytgMatch/simulatedStocks/myPortfolio/cancelEntrust", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        ytgMatchService = require("ytgMatchService"),//服务
		
		pageCode = "ytgMatch/simulatedStocks/myPortfolio/cancelEntrust", 
		_pageId = "#ytgMatch_simulatedStocks_myPortfolio_cancelEntrust ";
	...
	function fillEntrustData(result,insertType)
	{
		...
		for(var i = 0;i<result.length;i++)
		{
				...
				//不现实已成数据
				if (result[i].trade_status_name !="已成") {
					...
					html += '<li><span>金额</span>'+result[i].order_price * result[i].order_qty+'</li>';
