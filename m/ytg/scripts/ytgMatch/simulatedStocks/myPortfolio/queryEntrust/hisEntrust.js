 ...
 * @date 2016-03-16 （改）
 */
define("ytg/scripts/ytgMatch/simulatedStocks/myPortfolio/queryEntrust/hisEntrust",function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        ytgMatchService = require("ytgMatchService"),//服务
		
		pageCode = "ytgMatch/simulatedStocks/myPortfolio/queryEntrust/hisEntrust", 
		_pageId = "#ytgMatch_simulatedStocks_myPortfolio_queryEntrust_hisEntrust ";
	...
	function init() {
		...
		dateUtils.initDateUI("ytgMatch_simulatedStocks_myPortfolio_queryEntrust_hisEntrust",{"dateFormat":"yyyymmdd"});
	}
