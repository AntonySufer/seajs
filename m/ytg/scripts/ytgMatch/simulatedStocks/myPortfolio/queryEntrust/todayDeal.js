 ...
 * @date  2016-03-16
 */
define("ytg/scripts/ytgMatch/simulatedStocks/myPortfolio/queryEntrust/todayDeal", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
        ytgMatchService = require("ytgMatchService"),//服务
		
		pageCode = "ytgMatch/simulatedStocks/myPortfolio/queryEntrust/todayDeal", 
		_pageId = "#ytgMatch_simulatedStocks_myPortfolio_queryEntrust_todayDeal ";
