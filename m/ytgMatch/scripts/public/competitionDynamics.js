 ...
 * @date 2016-03-15
 */
define("ytgMatch/scripts/public/competitionDynamics", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
		pageCode = "public/competitionDynamics", 
		ytgMatchService = require("ytgMatchService"),//服务
		_pageId = "#public_competitionDynamics ";
			...
			$(_pageId + "#palying_activitys").html(html);
				...
				for(var i = 0;result !=null &&i<result.length;i++){
					...
					if(data.trade_type == "0"){//交易类型0:买入;1:卖出
						tradeTypeP = "<td class='ared'>买入</td>";
					} else if(data.trade_type == "1"){
						tradeTypeP = "<td class='agreen'>卖出</td>";
					}
			     ...
			     html += "<div class='dynamic_item'><div class='tit'>"
			          +" <div class='up'><span style='margin-right:0.2rem;'>"+data.exec_date+" "+data.exec_time+"</span><h3>"+data.name+"</h3></div>"
			          +" </div>"
