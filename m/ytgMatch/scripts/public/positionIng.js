 ...
 * 组合详情页
 */
define("ytgMatch/scripts/public/positionIng", function(require, exports, module){
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
		pageCode = "public/positionIng", 
		_pageId = "#public_positionIng ";
	//页面公共JS
	...
	//	var total_earnings = (result.total_earnings*1).toFixed(2); //总收益
		...
		var week_yield = (Number(result.week_yield)*100).toFixed(2); //7日收益
		...
		var small_img =result.face_image_small?result.face_image_small:"images/my_tx.png";
			...
			$(_pageId + "#create_drowChart").html("("+result.create_date.substring(0,10)+")");
