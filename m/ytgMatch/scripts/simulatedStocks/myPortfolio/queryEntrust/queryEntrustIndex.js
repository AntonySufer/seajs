 ...
 * @date 2016-03-16
 */
define("ytgMatch/scripts/simulatedStocks/myPortfolio/queryEntrust/queryEntrustIndex", function(require, exports, module) {
	var appUtils = require("appUtils"), 
	    layerUtils = require("layerUtils"), 
        gconfig = require("gconfig"),
		
		pageCode = "simulatedStocks/myPortfolio/queryEntrust/queryEntrustIndex", 
		_pageId = "#simulatedStocks_myPortfolio_queryEntrust_queryEntrustIndex ";
	...
	function bindPageEvent() {
		...
		appUtils.bindEvent($(_pageId + "#todayDeal"), function(e){
			appUtils.pageInit(pageCode,"simulatedStocks/myPortfolio/queryEntrust/todayDeal");
		});
